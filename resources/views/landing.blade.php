...
@section('content')
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 pt-8 pb-10">
    ...
    <div class="max-w-5xl mx-auto px-4"><x-ad slot="in_content" /></div>
    ...
    @if ($related->isNotEmpty())
        <section class="reveal-on-scroll max-w-6xl mx-auto px-4 pb-20">
