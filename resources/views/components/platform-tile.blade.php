@props(['name', 'color' => '#7c3aed'])

<div class="flex items-center gap-3 rounded-xl border border-gray-200/70 dark:border-white/10 bg-white dark:bg-white/[0.03] px-4 py-3 hover:border-violet-500/50 transition">
